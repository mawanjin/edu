...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/edu/customization/">私人定制模板列表</a></li>
		<li class="active"><a href="${ctx}/edu/customization/form?id=${customization.id}">私人定制模板<shiro:hasPermission name="edu:customization:edit">${not empty customization.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="edu:customization:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="customization" action="${ctx}/edu/customization/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span id="uploadBtn" class="btn btn-success"  <c:if test="${not empty customization.img}">style="display: none"</c:if>>
                            <i class="icon-plus icon-white"></i>
                            <span>上传图片</span>
				</span>
				<img id="portrait" <c:if test="${not empty customization.img}">src="${ctxImg}/${customization.img}"</c:if> />
		...
		<div class="form-actions">
			<shiro:hasPermission name="edu:customization:edit">
