...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/edu/convenience/">生活便利列表</a></li>
		<li class="active"><a href="${ctx}/edu/convenience/form?id=${convenience.id}">生活便利<shiro:hasPermission name="edu:convenience:edit">${not empty convenience.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="edu:convenience:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="convenience" action="${ctx}/edu/convenience/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span id="uploadBtn" class="btn btn-success"  <c:if test="${not empty convenience.img}">style="display: none"</c:if>>
                            <i class="icon-plus icon-white"></i>
                            <span>上传图片</span>
				</span>
				<img id="portrait" <c:if test="${not empty convenience.img}">src="${ctxImg}/${convenience.img}"</c:if> />

				<c:if test="${not empty convenience.img}">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<tags:ckeditor replace="content" uploadPath="/edu/convenience" />
			</div>
		</div>

		<div class="form-actions">
			<shiro:hasPermission name="edu:convenience:edit">
