...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/edu/abroadhomeTop/">海外之前图片列表</a></li>
		<li class="active"><a href="${ctx}/edu/abroadhomeTop/form?id=${abroadhomeTop.id}">海外之前图片<shiro:hasPermission name="edu:abroadhomeTop:edit">${not empty abroadhomeTop.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="edu:abroadhomeTop:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="abroadhomeTop" action="${ctx}/edu/abroadhomeTop/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="porder" htmlEscape="false"  maxlength="200" class="input-xxlarge"/>
			</div>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="edu:abroadhomeTop:edit">
