...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/edu/schoolNews/">学校新闻列表</a></li>
		<li class="active"><a href="${ctx}/edu/schoolNews/form?id=${schoolNews.id}">学校新闻<shiro:hasPermission name="edu:schoolNews:edit">${not empty schoolNews.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="edu:schoolNews:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<div class="container">
	...
	<form:form id="inputForm" modelAttribute="schoolNews" action="${ctx}/edu/schoolNews/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span id="uploadBtn" class="btn btn-success"  <c:if test="${not empty schoolNews.img}">style="display: none"</c:if>>
                            <i class="icon-plus icon-white"></i>
                            <span>上传图片</span>
				</span>
				<img id="portrait" <c:if test="${not empty schoolNews.img}">src="${ctxImg}/${schoolNews.img}"</c:if> />

				<c:if test="${not empty schoolNews.img}">
		...
		<div class="control-group">
			<label class="control-label" for="summary">所属学校:</label>
			<div class="controls">
				...
				<select name="school.id">
					<c:forEach items="${schools}" var="school">
						<option value="${school.id}" <c:if test="${not empty schoolNews.school and schoolNews.school.id eq school.id}">selected</c:if>>${school.name}</option>
					</c:forEach>
				</select>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<tags:ckeditor replace="content" uploadPath="/edu/schoolNews" />
			</div>
		</div>

		<div class="form-actions">
			<shiro:hasPermission name="edu:schoolNews:edit">
