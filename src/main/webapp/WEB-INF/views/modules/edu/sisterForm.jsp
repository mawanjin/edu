...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/edu/sister/">知心姐姐列表</a></li>
		<li class="active"><a href="${ctx}/edu/sister/form?id=${sister.id}">知心姐姐<shiro:hasPermission name="edu:sister:edit">${not empty sister.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="edu:sister:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="sister" action="${ctx}/edu/sister/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span id="uploadBtn" class="btn btn-success"  <c:if test="${not empty sister.img}">style="display: none"</c:if>>
                            <i class="icon-plus icon-white"></i>
                            <span>上传图片</span>
				</span>
				<img id="portrait" <c:if test="${not empty sister.img}">src="${ctxImg}/${sister.img}"</c:if> />
		...
		<div class="control-group">
			<label class="control-label" for="gendar">性别:</label>
			<div class="controls">
				<form:radiobutton path="gendar" value="0" checked="checked"   />男
				<form:radiobutton path="gendar" value="1" />女
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<tags:ckeditor replace="content" uploadPath="/edu/sister" />
			</div>
		</div>

		<div class="form-actions">
			<shiro:hasPermission name="edu:sister:edit">
