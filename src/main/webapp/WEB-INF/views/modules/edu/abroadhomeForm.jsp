...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/edu/abroadhome/">海外之家列表</a></li>
		<li class="active"><a href="${ctx}/edu/abroadhome/form?id=${abroadhome.id}">海外之家<shiro:hasPermission name="edu:abroadhome:edit">${not empty abroadhome.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="edu:abroadhome:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="abroadhome" action="${ctx}/edu/abroadhome/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<tags:ckeditor replace="content" uploadPath="/edu/abroadhome" />
			</div>
		</div>

		<div class="form-actions">
			<shiro:hasPermission name="edu:abroadhome:edit">
