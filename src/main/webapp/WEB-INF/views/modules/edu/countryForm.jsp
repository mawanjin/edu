...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/edu/country/">国家列表</a></li>
		<li class="active"><a href="${ctx}/edu/country/form?id=${country.id}">国家<shiro:hasPermission name="edu:country:edit">${not empty country.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="edu:country:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	...
	<form:form id="inputForm" modelAttribute="country" action="${ctx}/edu/country/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span id="uploadBtn" class="btn btn-success"  <c:if test="${not empty country.img}">style="display: none"</c:if>>
                            <i class="icon-plus icon-white"></i>
                            <span>上传图片</span>
				</span>
				<img id="portrait" <c:if test="${not empty country.img}">src="${ctxImg}/${country.img}"</c:if> />
		...
		<div class="control-group">
			<label class="control-label" for="hot">类型:</label>
			<div class="controls">
				<form:radiobuttons  path="hot" items="${fns:getDictList('edu_country_hot')}" itemLabel="label" itemValue="value" htmlEscape="false" />
			</div>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="edu:country:edit">
